                ...
                if ($ObjBBDD->comprobarConexion()) {
                    ...
                    if (isset($_SESSION["idusuario"])) {
                        if ($_SESSION["tipo"] == "b" || $_SESSION["tipo"] == "p") {
                            $sql = "select * from asignatura";//obtener datos de asignaturas
                                ...
                                echo "
                                    <form action='start.php' method='post'>
                                     ...
                                     while ($fila = $ObjBBDD->extraerFila($resultado)) {
                                         $sql2 = "select * from temario WHERE asignatura=".$fila["idasignatura"];//mostrar temarios de cada asignaturas
