...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2021 a las 13:48:36
...
(12, b'0', 'Dario', 'Manzanedo Reja', '2001-05-10', b'0', '80096493M', b'0');
...
(1, '2021-11-18 02:00:00', NULL, 9, 12, 2, b'1'),
(3, '2021-11-18 02:00:00', '2021-11-18 19:15:57', 7, 11, 1, b'1'),
(4, '2021-11-18 07:00:00', '2021-11-19 18:41:41', 10, 1, 2, b'1'),
(5, '2021-11-18 02:00:00', NULL, 7, 7, 2, b'1'),
(6, '2021-11-18 19:09:10', NULL, 12, 7, 1, b'1');
...
(11, 'Gestor3', 'g3@mind.net', '$2y$10$HnLaihwTB7REWpQeDXuCpOWCBORNDC1hq34WuodTtZE54M5DAG3SW', '2021-11-16 19:31:58', 'g'),
(12, 'Damanre', 'user1@mind.net', '$2y$10$r..XG4aDuiJmdSXFGNmaSeBNgvvmXn4AECbDXKWtX/to6cw.2U1lC', '2021-11-16 19:33:49', 'b');
...
--
ALTER TABLE `reunion`
  MODIFY `idreunion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `usuario`
  MODIFY `idusuario` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
